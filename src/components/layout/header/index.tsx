...
export default function Header() {
  ...
  if (user.role === 'sales') {
    return (
      <WorkspaceHeader roleName="SALES" roleColor="text-blue-600" searchPlaceholder="Tìm đơn hàng, SĐT khách...">
  ...
  if (user.role === 'operations') {
    return (
      <WorkspaceHeader roleName="OPERATIONS" roleColor="text-orange-600" searchPlaceholder="Quét mã vận đơn, SKU...">
