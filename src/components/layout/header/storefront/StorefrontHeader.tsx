    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
      <div className="container mx-auto px-4 h-16 md:h-20 flex items-center justify-between gap-8">
        ...
        <nav className="hidden lg:flex items-center gap-8 font-bold text-[11px] uppercase tracking-[0.2em] text-gray-500">
          <Link to="/products?cat=frames" className="hover:text-black transition-colors relative group">
            Kính Gọng
            <span className="absolute -bottom-1 left-0 w-0 h-px bg-black transition-all group-hover:w-full"></span>
          </Link>
          <Link to="/products?cat=lenses" className="hover:text-black transition-colors relative group">
            Tròng Kính
            <span className="absolute -bottom-1 left-0 w-0 h-px bg-black transition-all group-hover:w-full"></span>
          </Link>
