    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <header className="bg-primary px-4 py-4">
                <p className="text-sm text-primary-foreground/80">Đang giao</p>
            ...
            <main className="flex-1 px-4 py-4 pb-40 space-y-4">
                ...
                <div className="rounded-lg bg-card border border-border p-4">
                    ...
                    <p className="text-xl font-bold text-foreground">{order.customerId}</p>
                </div>
            ...
            <div className={`fixed bottom-0 ${collapsed ? 'left-16' : 'left-64'} right-0 bg-card border-t border-border p-4 space-y-3 safe-bottom transition-all duration-300`}>
                <button
                    type="button"
                    onClick={onComplete}
