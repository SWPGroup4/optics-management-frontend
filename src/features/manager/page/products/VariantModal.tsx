...
export default function VariantModal({ open, onClose, onSubmit, variant, isSubmitting = false }: any) {
  ...
  const inputClass = "w-full border border-slate-200 rounded-xl px-3 py-2.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 bg-slate-50/50 transition-all";
