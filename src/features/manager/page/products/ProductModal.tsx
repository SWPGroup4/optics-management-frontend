        ...
        <div className="overflow-y-auto px-7 py-6 flex-1">
          <div className="grid grid-cols-2 gap-x-5 gap-y-4">
            ...
            <div className="col-span-2">
              ...
              <input name="name" placeholder="e.g. Classic Aviator Frame"
                value={form.name} onChange={handleChange} className={inputClass} />
            </div>

            <div>
              <label className={labelClass}>Brand *</label>
              <input name="brand" placeholder="e.g. Ray-Ban"
            ...
            <div>
              ...
              <input name="shape" placeholder="e.g. Rectangular"
                value={form.shape} onChange={handleChange} className={inputClass} />
            </div>

            <div>
              <label className={labelClass}>Frame Material</label>
              <input name="frameMaterial" placeholder="e.g. Titanium"
                value={form.frameMaterial} onChange={handleChange} className={inputClass} />
            </div>

            <div>
              <label className={labelClass}>Hinge Type</label>
              <input name="hingeType" placeholder="e.g. Spring hinge"
                value={form.hingeType} onChange={handleChange} className={inputClass} />
            </div>

            <div>
              <label className={labelClass}>Nose Pad Type</label>
              <input name="nosePadType" placeholder="e.g. Adjustable"
                value={form.nosePadType} onChange={handleChange} className={inputClass} />
            </div>

            <div>
              <label className={labelClass}>Weight (gram)</label>
              <input type="number" name="weightGram" placeholder="e.g. 28"
                value={form.weightGram || ""} onChange={handleChange} className={inputClass} min={0} />
            </div>
