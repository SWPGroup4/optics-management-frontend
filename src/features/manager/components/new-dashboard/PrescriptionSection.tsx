                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-center">
                        ...
                        <tr className="bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
                            ...
                            <th className="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-widest w-[22.5%]">SPH (Cầu)</th>
                            <th className="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-widest w-[22.5%]">CYL (Loạn)</th>
                            <th className="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-widest w-[22.5%]">AXIS (Trục)</th>
                            <th className="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-widest w-[22.5%]">PD (KC)</th>
                        </tr>
                        </thead>
