...
export function OrdersTable() {
  ...
  const { orders, isLoading, error, fetchOrders, fetchOrderById, deleteOrder, filterByStatus } =
    useOrderStore();
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    ${(selectedOrder?.totalAmount - selectedOrder?.depositAmount)?.toFixed(2)}
                  </p>
                </div>
              </div>
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <div className="flex gap-2 mt-1">
                            <Badge variant="outline">{item.orderItemType?.replace('_', ' ')}</Badge>
