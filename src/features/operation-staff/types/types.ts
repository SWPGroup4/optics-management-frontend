...
export type BEOrderStatus = 'PENDING' | 'AWAITING_VERIFICATION' | 'ON_HOLD' | 'CONFIRMED' | 'AWAITING_FINAL_PAYMENT' | 'PREPARING' | 'PROCESSING' | 'PRODUCED' | 'READY_TO_SHIP' | 'SHIPPED' | 'DELIVERING' | 'DELIVERED' | 'COMPLETED' | 'CANCELLED';
