...
const PaymentInfoSection: React.FC<PaymentInfoSectionProps> = ({ order }) => {
    ...
    const displayValue = (value: string | null | undefined, fallback: string = 'Chưa có thông tin') => {
            ...
            <div className="bg-white dark:bg-[#1a2e22] rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        <p className="text-sm font-medium text-slate-600 dark:text-slate-400">Địa chỉ giao hàng</p>
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-4 space-y-3">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <p className="text-sm font-medium text-slate-600 dark:text-slate-400 mb-3">Chi tiết thanh toán</p>
