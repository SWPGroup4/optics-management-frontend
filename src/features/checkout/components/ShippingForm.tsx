...
import { MapPin, Phone, Truck, LocateFixed, Loader2, Map as MapIcon } from "lucide-react";
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.05)] space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-5">
        <div className="space-y-2">
          ...
          <div className="relative flex items-center">
            ...
            <Input 
              ...
              onBlur={handleAddressBlur} // THÊM SỰ KIỆN NÀY ĐỂ TÌM BẢN ĐỒ KHI GÕ XONG
              onKeyDown={(e) => {
                 // Nếu bấm Enter thì cũng chạy tìm kiếm bản đồ luôn
            ...
            <div className="absolute inset-y-0 right-1 flex items-center">
              ...
              >
                {isLocating ? <Loader2 className="w-5 h-5 animate-spin" /> : <LocateFixed className="w-5 h-5 group-hover:scale-110" />}
              </button>
            </div>
          </div>

          {/* ... GIỮ NGUYÊN PHẦN HIỂN THỊ IFRAME BẢN ĐỒ ... */}
          {coords && (
            <div className="mt-3 overflow-hidden rounded-xl border border-gray-200 shadow-sm animate-in fade-in slide-in-from-top-2 duration-500">
              <div className="bg-gray-50 px-3 py-2 border-b border-gray-200 flex items-center gap-2">
                ...
                <span className="text-xs font-semibold text-gray-600">Vị trí giao hàng dự kiến</span>
              </div>
              <iframe
                title="Map"
                width="100%"
        ...
        {/* ... GIỮ NGUYÊN INPUT SỐ ĐIỆN THOẠI ... */}
